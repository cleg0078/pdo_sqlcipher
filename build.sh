...
CFLAGS=" \
	...
	-DSQLITE_ENABLE_STATIC \
	-DSQLITE_DEFAULT_FOREIGN_KEYS=1 \
	-I. -I/usr/local/include"

LDFLAGS="-lcrypto -licuuc -licui18n -L/usr/local/lib -lm -DSQLITE_HAS_CODEC -DHAVE_READLINE -lreadline -lncurses -g"
...
#PHP8.2 AND ABOVE 
sed -i 's/sqlite3_stricmp/sqlcipher3_stricmp/g' "${BUILD_DIR}/sqlcipher3.c"
sed -i 's/sqlite3_mprintf/sqlcipher3_mprintf/g' "${BUILD_DIR}/sqlcipher3.c"
